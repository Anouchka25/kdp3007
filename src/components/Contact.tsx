...
const contacts = [
  {
    ...
    icon: Phone,
    adresse: "319 Route de la Chapelle, 76640 Cléville",
    iconeA: Map
  },
  {
    country: "Gabon",
    ...
    icon: Phone,
    adresse: "Rond-point d'Avorbam, Akanda - Entreprise Allo Glaçons",
    iconeA: Map
  },
  {
    country: "Chine",
  ...
  return (
    <section id="contact" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Cartes de contact par pays */}
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {contacts.map((contact, index) => {
            const Icon = contact.icon;
            const IconA = contact.iconeA;
            return (
              <div
                key={index}
                className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-200"
              >
                {/* En-tête drapeau + pays */}
                <div className="flex items-center">
                  <Icon className="h-6 w-6 text-yellow-500" />
                  <img
                    src={contact.flag}
                    alt={`Drapeau de ${contact.country}`}
                    className="h-4 ml-2"
                  />
                ...
                <div className="mt-4 flex items-center text-base text-gray-500">
                  <IconA className="h-5 w-5 mr-2 text-yellow-500" />
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-center">
            <a
              ...
              className="flex items-center text-base text-gray-500 hover:text-yellow-500 transition-colors duration-150"
            >
