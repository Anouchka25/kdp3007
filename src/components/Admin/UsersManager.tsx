...
const UsersManager = () => {
  ...
  const getDocumentStatus = (docType: string, side?: string) => {
    return userDocuments.find(doc => doc.document_type === docType && (!side || doc.side === side));
  };
                ...
                <div>
                  ...
                  <p className="mt-1">
                    {selectedUser.country === 'GA' ? 'Gabon' :
                     ...
                     selectedUser.country === 'CH' ? 'Suisse' :
                     selectedUser.country === 'GB' ? 'Royaume-Uni' :
                     selectedUser.country === 'ES' ? 'Espagne' :
                     selectedUser.country === 'IT' ? 'Italie' :
                     selectedUser.country === 'NL' ? 'Pays-Bas' :
